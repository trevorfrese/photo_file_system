        ...
        with con:
            ...
            if(row is None):
                ...
                try:
                    ...
                    xml_string = str(res.toxml())
                    #
                    block_id = xml_string.split("<photoid>")[1].split("<")[0] + "\n"

                    print "FILE IDS " + xml_string.split("<photoid>")[1].split("<")[0]
                    
                    #block_list = open("block_list.txt", "a")
                    #block_list.write(block_id)
                    #block_list.close()
                    with open("upload_pics/block_list.txt", 'a') as the_file:
                        the_file.write(block_id)
                        print "WE'RE SUPPOSED TO BE WRITING HERE"
                    

                    print "YOYOYOYOYOYO RESSSSS IS ", res
